...
class Slider(Frame):
    ...
    def __init__(self, master, width = 400, height = 80, min_val = 0, max_val = 1, init_lis = None, show_value = True):
        ...
        self.canv = Canvas(self, height = self.canv_H, width = self.canv_W, bg='#333333', highlightbackground='#333333', selectforeground='#dddddd')
        self.canv.pack()
    ...
    def __addBar(self, pos):
        ...
        if self.show_value:
            ...
            id_value = self.canv.create_text(x,y_value, text = format(int(value)), font= ("Courier", "14"), activefill="white", disabledfill="white", fill="white")
